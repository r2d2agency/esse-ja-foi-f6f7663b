          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <div className="aspect-video bg-slate-100 rounded-3xl overflow-hidden relative group">
                ...
                <LegendaFotoBadge
                  legenda={anuncio.fotos?.[activePhoto]?.legenda}
                  ...
                  <div className="bg-white/5 border border-white/10 rounded-3xl p-6 space-y-6">
                    ...
                    <div className="flex flex-wrap gap-3">
                      <Button
                        ...
                        className="h-auto min-h-14 flex-1 basis-[140px] min-w-0 whitespace-normal break-words px-3 py-2 text-center leading-tight bg-teal-600 hover:bg-teal-700 text-white font-black text-xs uppercase rounded-2xl shadow-lg shadow-teal-900/20"
                      >
                      ...
                      <Button
                        ...
                        disabled={!podeDarLances || darLanceMutation.isPending || lancesBloqueados}
                        variant="outline"
                        className="h-auto min-h-14 flex-1 basis-[140px] min-w-0 whitespace-normal break-words px-3 py-2 text-center leading-tight border-white/20 bg-transparent text-white hover:bg-white/10 hover:text-white font-black text-xs uppercase rounded-2xl"
                      >
              ...
              {isAuthenticated && (
                <div className="mt-8 flex flex-wrap gap-3">
                  <Button
                    ...
                    className="h-auto min-h-12 flex-1 basis-[140px] min-w-0 whitespace-normal px-3 py-2 rounded-2xl border-white/20 bg-transparent text-xs font-black uppercase text-white hover:bg-white/10 hover:text-white"
                  >
                    <Heart
