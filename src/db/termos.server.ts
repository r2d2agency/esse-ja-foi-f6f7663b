...
1. O VENDEDOR declara ser o legítimo proprietário do(s) veículo(s) cadastrado(s) e autoriza a plataforma ESSE JÁ FOI a divulgar, anunciar e submeter o(s) veículo(s) a lance eletrônico.
...
3. O VENDEDOR autoriza a plataforma a intermediar a negociação, receber propostas e conduzir o encerramento da venda ao maior ofertante, observadas as regras do lance.
...
2. O COMPRADOR reconhece que todo lance registrado na plataforma é uma oferta de compra vinculante e irrevogável, condicionada apenas ao encerramento do lance a seu favor.
3. O COMPRADOR se compromete a efetuar o pagamento e retirar o veículo arrematado nos prazos e condições informados no fechamento de cada lance.
